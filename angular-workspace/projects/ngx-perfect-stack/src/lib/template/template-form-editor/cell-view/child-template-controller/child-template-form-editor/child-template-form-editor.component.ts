...
@Component({
  selector: 'lib-child-template-form-editor',
  templateUrl: './child-template-form-editor.component.html',
  styleUrls: ['./child-template-form-editor.component.css']
})
export class ChildTemplateFormEditorComponent implements OnInit {
